...
public class BaseSharedPreference {
    ...
    private final String SHAREDPREFERENCES_NAME = "BYJI_PREFERENCES";
    ...
    void putIntValues(String Tag, int Value) {
        SharedPreferences.Editor saveuser = sharedpre.edit();
